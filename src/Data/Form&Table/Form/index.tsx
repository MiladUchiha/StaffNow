...
export const MultiWithHeaderData2 = [
  { area: "NBA Teams", header: true },
  { area: "Boston Celtics" },
  { area: "Dallas Mavericks" },
  { area: "Brooklyn Nets" },
  { area: "Houston Rockets" },
  { area: "New York Knicks" },
  { area: "Memphis Grizzlies" },
  { area: "Philadelphia 76ers" },
  { area: "New Orleans Hornets" },
  { area: "Toronto Raptors" },
  { area: "San Antonio Spurs" },
  { area: "Chicago Bulls" },
  { area: "Denver Nuggets" },
  { area: "Cleveland Cavaliers" },
  { area: "Minnesota Timberwolves" },
  { area: "Detroit Pistons" },
  { area: "Portland Trail Blazers" },
  { area: "Indiana Pacers" },
  { area: "Oklahoma City Thunder" },
  { area: "Milwaukee Bucks" },
  { area: "Utah Jazz" },
  { area: "Atlanta Hawks" },
  { area: "Golden State Warriors" },
  { area: "Charlotte Bobcats" },
  { area: "Los Angeles Clippers" },
  { area: "Miami Heat" },
  { area: "Los Angeles Lakers" },
  { area: "Orlando Magic" },
  { area: "Phoenix Suns" },
  { area: "Washington Wizards" },
  { area: "Sacramento King" },
  { area: "", divider: true },
  { area: "NHL Teams", header: true },
  { area: "Boston Celtics" },
  { area: "Dallas Mavericks" },
  { area: "Brooklyn Nets" },
  { area: "Houston Rockets" },
