  ...
  return (
    <div className="modal-toggle-wrapper">
      <ul className="modal-img">
        <li><Image src={`${ImagePath}/gif/whatapp.gif`} alt="whatsapp" /></li>
        <li><Image src={`${ImagePath}/gif/instagram.gif`} alt="instagram" /></li>
        <li><Image src={`${ImagePath}/gif/facebook.gif`} alt="facebook" /></li>
      </ul>
