          ...
          <div className="scroll-bar-wrap">
            <ScrollBar className="scroll-demo" style={{width:"100%", height:"300px"}}>
              <div className="horz-scroll-content">
                <Row>
                  <Col sm="3">
                    <div className="visible-wrapper"><Image src={`${ImagePath}/banner/2.jpg`} alt="office-work" /></div>
                    <p className="pt-3">Inspiration can take many different forms, and <em className="txt-danger">professional growth never stops</em>. In light of this, weve compiled a comprehensive list of web design blogs that will keep your mind stimulated for the entire year. You wont find any stinkers on this list, so dont worry. We value your time and believe that you should only receive the greatest. Because of this, we only gathered web design blogs that have recently being updated. Get ready to add numerous subscriptions by creating your Feebly account.<br />{`-->`} Responsive...<br />{`-->`} Secure your domain...<br />{`-->`} Testing...<br />{`-->`} Content creation...<br />{`-->`} Visual elements...<br />{`-->`} Launch...</p>
                  </Col>
                  <Col sm="3">
                  ...
                  <Col sm="3">
                    ...
                    <p>The internet is teeming with free resources, no matter what stage of your UX journey youre in, and UX design blogs should be your first point of call. The abundance of blogs available, though, can be somewhat of a double-edged sword because there are so many to choose from. How do you decide which blogs are actually worthwhile reading?</p>
                    <p>Weve collected a selection of the top UX design blogs available right now to spare you hours of scrolling and sorting through search results. We possess:<br /><strong>1. Muzli </strong><br /><strong>2. Facebook Design </strong><br /><strong>3. Awwwards</strong><br /></p>
                    <p>If you already work in the UX field, the Inside Design blog has all the information you need to expand your knowledge, especially if youre interested in streamlining your UX teams and procedures and getting a better understanding of the whole product design and development process. This is an excellent location to keep an eye out for the most recent UX trends, tools, resources, and events because they are always adding new stuff.</p>
                  </Col>
                  <Col sm="3">
