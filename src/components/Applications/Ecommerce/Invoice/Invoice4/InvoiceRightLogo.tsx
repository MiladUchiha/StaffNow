...
const InvoiceRightLogo = () => {
  return (
    <td>
      <Image className="img-fluid for-light" src={`${ImagePath}/logo/logo.png`} alt="logo" style={{ marginBottom: 14 }} />
      <Image className="img-fluid for-dark" src={`${ImagePath}/logo/logo_light.png`} alt="logo" style={{ marginBottom: 14 }} />
