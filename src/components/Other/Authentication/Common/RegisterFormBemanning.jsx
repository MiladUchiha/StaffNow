  ...
  return (
    <div>
      ...
      <div className="login-main">
        <Formik initialValues={{ name: "", companyName: "", organizationNumber: "", address: "", branches: [], areas:[], crewNumber: "" , email: "", description: "", password: "", }} onSubmit={handleSubmit}>
            ...
            <Form className="theme-form">
              ...
              <Row className="g-2">
                ...
                <Typeahead
                  ...
                  id="multiple-typeahead" labelKey={"area"} multiple options={MultiWithHeaderData2} placeholder="Vilka tjänste områdes" className="form-control" />
                  </Col>
                </Row>
              ...
              <FormGroup >
                ...
                <Field
                      ...
                      className="form-control" type="number" name="adress" required placeholder="Hur många personel har ni tillgänglig?" />
              </FormGroup>
              <FormGroup>
                <Row className="g-2">
                  <Col sm="6">
